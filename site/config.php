...
* Template files can reside in the parent or current theme, the CWebbit::ThemeEngineRender()
...
*
* path: Path to current theme, relativly WEBBIT_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
