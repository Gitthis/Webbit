<?php
/**
* Holding a instance of CWebbit to enable use of $this in subclasses and provide some helpers.
*
* @package WebbitCore
*/
class CObject {
...
/**
* Wrapper for same method in CWebbit. See there for documentation.
*/
