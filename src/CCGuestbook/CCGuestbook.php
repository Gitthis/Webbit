...
class CCGuestbook extends CObject implements IController {
  ...
  private $pageTitle = 'Webbit Guestbook';
  private $pageHeader = '<h1>Guestbook Example</h1><p>Showing off how to implement a guestbook in Webbit. Now saving to database.</p>';
