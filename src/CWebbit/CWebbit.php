<?php
/**
* Main class for Webbit, holds everything.
*
* @package WebbitCore
*/
...
* @return CWebbit The instance of this class.
*/
public static function Instance() {
if(self::$instance == null) {
self::$instance = new CWebbit();
}
...
*/
  public function ThemeEngineRender() {
    ...
    $themePath = WEBBIT_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = WEBBIT_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    $ly = &$this;
    // First the default Webbit themes/functions.php
