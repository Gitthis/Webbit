<?php
/**
* A model for managing Webbit modules.
*
* @package WebbitCore
*/
...
* Properties
*/
  private $webbitCoreModules = array('CWebbit', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $webbitCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
...
*/
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isWebbitCore'] = in_array($rc->name, $this->webbitCoreModules);
      $details['isWebbitCMF'] = in_array($rc->name, $this->webbitCMFModules);
